...
class SchoolServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.GetStudentIdsOfSchoolResponse> getStudentIdsOfSchool(
    $0.GetStudentIdsOfSchoolRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.GetBulkClassNameResponse> getBulkClassName(
    $0.GetBulkClassNameRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$getStudentIdsOfSchool = $grpc.ClientMethod<
          $0.GetStudentIdsOfSchoolRequest, $0.GetStudentIdsOfSchoolResponse>(
  ...
  static final _$getBulkClassName = $grpc.ClientMethod<
          $0.GetBulkClassNameRequest, $0.GetBulkClassNameResponse>(
...
abstract class SchoolServiceBase extends $grpc.Service {
  ...
  SchoolServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetStudentIdsOfSchoolRequest,
            $0.GetStudentIdsOfSchoolResponse>(
        'GetStudentIdsOfSchool',
        getStudentIdsOfSchool_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
    ...
    $addMethod($grpc.ServiceMethod<
        ...
        ($0.GetStudentsInfoOfSchoolForEnrollmentResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetBulkClassNameRequest,
            $0.GetBulkClassNameResponse>(
        'GetBulkClassName',
  ...
  $async.Future<$0.GetStudentIdsOfSchoolResponse> getStudentIdsOfSchool_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetStudentIdsOfSchoolRequest> $request) async {
    return getStudentIdsOfSchool($call, await $request);
  }
  ...
  $async.Future<$0.GetBulkClassNameResponse> getBulkClassName_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetBulkClassNameRequest> $request) async {
