...
class GatewayServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$1.EnrollStudentsToClassResponse> enrollStudentsToClass(
    $1.EnrollStudentsToClassRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$2.GetOrganizationShiftsForDayResponse>
      getOrganizationShiftsForDay(
    $2.GetOrganizationShiftsForDayRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$2.GetUserShiftsOfAttendanceMonthResponse>
  ...
  $grpc.ResponseFuture<$2.GetShiftsNamesResponse> getShiftsNames(
    $2.GetShiftsNamesRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$5.GetBatchUsersInfoOfSchoolForLiveFeedResponse>
    ...
    return $createUnaryCall(_$getBatchUsersInfoOfSchoolForLiveFeed, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$5.ListStudentsOfSchoolForEnrollmentResponse>
  ...
  static final _$enrollStudentsToClass = $grpc.ClientMethod<
          $1.EnrollStudentsToClassRequest, $1.EnrollStudentsToClassResponse>(
  ...
  static final _$getOrganizationShiftsForDay = $grpc.ClientMethod<
          $2.GetOrganizationShiftsForDayRequest,
          $2.GetOrganizationShiftsForDayResponse>(
      '/gateway.GatewayService/GetOrganizationShiftsForDay',
      ($2.GetOrganizationShiftsForDayRequest value) => value.writeToBuffer(),
      $2.GetOrganizationShiftsForDayResponse.fromBuffer);
  static final _$getUserShiftsOfAttendanceMonth = $grpc.ClientMethod<
          $2.GetUserShiftsOfAttendanceMonthRequest,
          $2.GetUserShiftsOfAttendanceMonthResponse>(
  ...
  static final _$getShiftsNames =
      $grpc.ClientMethod<$2.GetShiftsNamesRequest, $2.GetShiftsNamesResponse>(
          '/gateway.GatewayService/GetShiftsNames',
          ($2.GetShiftsNamesRequest value) => value.writeToBuffer(),
          $2.GetShiftsNamesResponse.fromBuffer);
  ...
  static final _$listEmployeesOfSchool = $grpc.ClientMethod<
          $5.ListEmployeesOfSchoolRequest, $5.ListEmployeesOfSchoolResponse>(
  ...
  static final _$listInstitutionLeaves = $grpc.ClientMethod<
          $5.ListInstitutionLeavesRequest, $5.ListInstitutionLeavesResponse>(
  ...
  static final _$getBatchUsersInfoOfSchoolForLiveFeed = $grpc.ClientMethod<
          $5.GetBatchUsersInfoOfSchoolForLiveFeedRequest,
          $5.GetBatchUsersInfoOfSchoolForLiveFeedResponse>(
      '/gateway.GatewayService/GetBatchUsersInfoOfSchoolForLiveFeed',
  ...
  static final _$listStudentsOfSchoolForEnrollment = $grpc.ClientMethod<
          $5.ListStudentsOfSchoolForEnrollmentRequest,
          $5.ListStudentsOfSchoolForEnrollmentResponse>(
...
abstract class GatewayServiceBase extends $grpc.Service {
  ...
  GatewayServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.GetClassesSelectionMenuItemsRequest,
        ...
        ($1.GetClassesSelectionMenuItemsResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.EnrollStudentsToClassRequest,
    ...
    $addMethod($grpc.ServiceMethod<$2.GetOrganizationShiftsForDayRequest,
            $2.GetOrganizationShiftsForDayResponse>(
        'GetOrganizationShiftsForDay',
        ...
        false,
        ($core.List<$core.int> value) =>
            $2.GetOrganizationShiftsForDayRequest.fromBuffer(value),
        ($2.GetOrganizationShiftsForDayResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.GetUserShiftsOfAttendanceMonthRequest,
            $2.GetUserShiftsOfAttendanceMonthResponse>(
        'GetUserShiftsOfAttendanceMonth',
    ...
    $addMethod($grpc.ServiceMethod<$2.GetShiftsNamesRequest,
            $2.GetShiftsNamesResponse>(
        'GetShiftsNames',
        getShiftsNames_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.GetShiftsNamesRequest.fromBuffer(value),
        ($2.GetShiftsNamesResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$5.ListEmployeesOfSchoolRequest,
            $5.ListEmployeesOfSchoolResponse>(
        'ListEmployeesOfSchool',
        listEmployeesOfSchool_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
    ...
    $addMethod($grpc.ServiceMethod<$5.GetEmployeesSelectionMenuItemsRequest,
        ...
        ($5.GetEmployeesSelectionMenuItemsResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$5.ListInstitutionLeavesRequest,
            $5.ListInstitutionLeavesResponse>(
        'ListInstitutionLeaves',
        listInstitutionLeaves_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
    ...
    $addMethod($grpc.ServiceMethod<
            ...
            $5.GetBatchUsersInfoOfSchoolForLiveFeedResponse>(
        'GetBatchUsersInfoOfSchoolForLiveFeed',
        getBatchUsersInfoOfSchoolForLiveFeed_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
    ...
    $addMethod($grpc.ServiceMethod<$5.ListStudentsOfSchoolOfClassRequest,
        ...
        ($5.ListStudentsOfSchoolOfClassResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$5.ListStudentsOfSchoolForEnrollmentRequest,
            $5.ListStudentsOfSchoolForEnrollmentResponse>(
        'ListStudentsOfSchoolForEnrollment',
  ...
  $async.Future<$1.EnrollStudentsToClassResponse> enrollStudentsToClass_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$1.EnrollStudentsToClassRequest> $request) async {
  ...
  $async.Future<$2.GetOrganizationShiftsForDayResponse>
      getOrganizationShiftsForDay_Pre($grpc.ServiceCall $call,
          $async.Future<$2.GetOrganizationShiftsForDayRequest> $request) async {
  ...
  $async.Future<$2.GetUserShiftsOfAttendanceMonthResponse>
      getUserShiftsOfAttendanceMonth_Pre(
          $grpc.ServiceCall $call,
          $async.Future<$2.GetUserShiftsOfAttendanceMonthRequest>
              $request) async {
  ...
  $async.Future<$2.GetShiftsNamesResponse> getShiftsNames_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$2.GetShiftsNamesRequest> $request) async {
    return getShiftsNames($call, await $request);
  }

  $async.Future<$2.GetShiftsNamesResponse> getShiftsNames(
      $grpc.ServiceCall call, $2.GetShiftsNamesRequest request);
  ...
  $async.Future<$5.ListEmployeesOfSchoolResponse> listEmployeesOfSchool_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$5.ListEmployeesOfSchoolRequest> $request) async {
    return listEmployeesOfSchool($call, await $request);
  }
  ...
  $async.Future<$5.ListInstitutionLeavesResponse> listInstitutionLeaves_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$5.ListInstitutionLeavesRequest> $request) async {
    return listInstitutionLeaves($call, await $request);
  }
  ...
  $async.Future<$5.GetBatchUsersInfoOfSchoolForLiveFeedResponse>
      getBatchUsersInfoOfSchoolForLiveFeed_Pre(
          $grpc.ServiceCall $call,
          $async.Future<$5.GetBatchUsersInfoOfSchoolForLiveFeedRequest>
              $request) async {
    return getBatchUsersInfoOfSchoolForLiveFeed($call, await $request);
  }
  ...
  $async.Future<$5.ListStudentsOfSchoolForEnrollmentResponse>
      listStudentsOfSchoolForEnrollment_Pre(
          $grpc.ServiceCall $call,
          $async.Future<$5.ListStudentsOfSchoolForEnrollmentRequest>
              $request) async {
